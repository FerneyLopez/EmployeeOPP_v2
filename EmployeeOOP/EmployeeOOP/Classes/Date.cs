...
namespace EmployeeOOP.Classes
{
    public class Date
    {
        ...
        //Privados por que van a ser propios de esta clase, no se van a utilizar de manera externa.
        private int _year; //Campos a ser utilizados.
        private int _month;
        private int _day;
        ...
        //Método constructor sobre cargado. Atajo, se escribe ctor y tabulación, genera un constructor
        public Date(int day, int month, int year)
        {
            //validaciones de datos por medio de argumentos en los métodos.
            //Antes de asignar un valor a los campos del constructor validarlo.
        ...
        private int ValidateMonth(int month)
        {
            ...
            {
                //si el mes no es válido retornarlo con una excepcion.
                //Una excepción no se ejecuta, se lanza.
                //Exception creation
                throw new MonthException(String.Format("El mes {0} no es válido.", month));
            }
        }

        //Método utilizado para sobreescribir el ´método toSting() de la clase program.cs ya que imprime el objeto,
        //no los valores almacenados.
        public override string ToString()
        {
            //Tres formas de hacer la concatenación.
            //dia/mes/año
            ...
            var dateConcatenated3 = String.Format("{0:00}/{1:00}/{2:00}", _day, _month, _year); // Class String.Format siempre se comeinza desde el cero
